...
（**当前 142,131 B = 138.8 KiB（2026-09-21 晚：分屏 136.8 之后又加了标签拖拽 +1.9 KB、跳到时间 / 补全的接线几百字节），已过 138 KiB 告警线，红线 150 KB**；CI 算的是 `size / 1024` 取整。清单上能搬的都搬完了（2026-09-21 两段），**下一步是动红线本身**：JOURNAL 09-18 量过入口包只占启动的 14%，建议 138/150 → 145/160，等用户拍板。
